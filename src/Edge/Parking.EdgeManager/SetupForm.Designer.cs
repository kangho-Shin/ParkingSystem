...
partial class SetupForm
{
    ...
    private Label _parkingApiUrlLabel = null!;
    ...
    private TextBox _parkingApiUrl = null!;
    ...
    private void InitializeComponent()
    {
        ...
        _centralServerUrlLabel.Text = "Gateway 주소";
        _parkingApiUrlLabel.Anchor = AnchorStyles.Left;
        _parkingApiUrlLabel.AutoSize = true;
        _parkingApiUrlLabel.Text = "Parking API 주소";
        ...
        _parkingApiUrl.Dock = DockStyle.Fill;
        _parkingApiUrl.Text = "http://localhost:5000/";
        ...
        _layout.Controls.Add(_parkingApiUrlLabel, 0, 2);
        _layout.Controls.Add(_parkingApiUrl, 1, 2);
        _layout.Controls.Add(_imageServerUrlLabel, 0, 3);
        _layout.Controls.Add(_imageServerUrl, 1, 3);
        _layout.Controls.Add(_siteAuthKeyLabel, 0, 4);
        _layout.Controls.Add(_siteAuthKey, 1, 4);
        _layout.Controls.Add(_imageWatchPathLabel, 0, 5);
        _layout.Controls.Add(_imageWatchPath, 1, 5);
        _layout.Controls.Add(_buttonLayout, 0, 6);
        _layout.SetColumnSpan(_buttonLayout, 2);
        Controls.Add(_layout);
        AcceptButton = _saveButton;
        ClientSize = new Size(604, 366);
