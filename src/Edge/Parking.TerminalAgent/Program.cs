...
namespace Parking.TerminalAgent
{
    public class Program
    {
        private static async Task Main(string[] args)
        {
            ...
            {
                options.ServiceName = "Parking Terminal Agent";
            });

            builder.Services.Configure<TerminalAgentOptions>(
                builder.Configuration.GetSection("TerminalAgent"));
            ...
            builder.Logging.AddProvider(
                new DailyFileLoggerProvider(startupOptions.LogDirectory));
