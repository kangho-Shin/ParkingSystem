...
public sealed class ParkingSearchRepositoryTests
{
    ...
    public async Task 뒤4자리_조회는_같은그룹_미출차차량을_최신순으로_반환한다()
    {
        ...
        long firstId = await CreateSessionAsync("12가3456", 1, "IN-1.jpg", baseTime, "I");
        long secondId = await CreateSessionAsync("34나3456", 1, "IN-2.jpg", baseTime.AddHours(1), "I");
        await CreateSessionAsync("56다3456", 2, "OTHER-GROUP.jpg", baseTime.AddHours(2), "I");
        await CreateSessionAsync("78라3456", 1, "EXITED.jpg", baseTime.AddHours(2), "O");
        ...
        IReadOnlyList<ParkingSearchCandidate> suffixResult = await repository.SearchAsync(
            1, 1, "3456", CancellationToken.None);
        ...
        string outFlag)
    {
        ...
        return await connection.ExecuteScalarAsync<long>("""
            ...
            VALUES
            (1,@EventId,@CarNumber,@Groupnum,1,10,101,@InDateTime,@InImage,@OutFlag);
