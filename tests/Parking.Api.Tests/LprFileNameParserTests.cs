...
public sealed class LprFileNameParserTests
{
    ...
    [Fact]
    public void 실제DB식별자와_3자리장치번호를_읽는다()
    {
        LprParseResult result = _parser.Parse(
            "9001_002_402_9020_Exit_20260920103000123_12가3456_4a912811cb4d4c3fa934de51805a52d1.jpg");

        Assert.True(result.Success);
        Assert.Equal(9001, result.Recognition!.SiteId);
        Assert.Equal(402, result.Recognition.DeviceId);
        Assert.Equal(9020, result.Recognition.LaneId);
    }

    [Theory]
    [InlineData("0_002_101_010_Entry_20260919153025123_12가3456_4a912811cb4d4c3fa934de51805a52d1.jpg")]
