...
namespace JPXLpr.Novitec
{
    ...
    class IPCameraUtils
    {
        public static Bitmap? CreateBitmapFromJpeg(byte[] jpeg)
        {
        ...
        public static Bitmap? CreateGrayBitmap(byte[] buffer, int width, int height)
        {
            ...
            try {
                ...
                for (int y = 0; y < height; y++) {
                    ...
                    System.Runtime.InteropServices.Marshal.Copy(buffer, y * width, dest, width);
                }
            }
            finally {
    ...
    public class YUVtoRGB
    {
        ...
        public Bitmap GetBitmap_YUVtoRGB_incremental()
        {
            try {
                ...
                try {
                    System.Runtime.InteropServices.Marshal.Copy(
                        m_rgb, 0, data.Scan0, m_width * m_height * 4);
                }
                finally {
                    bitmap.UnlockBits(data);
                }
