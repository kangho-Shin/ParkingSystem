...
namespace JPXLpr.Novitec
{
    ...
    public enum Model
    {
        ...
        iN2_23OC_C, // i-Nova2 Compact (Onsemi, 2.3MP)
    ...
    public class IPCamera
    {
        ...
        public IPCamError GetImage_TCP(int timeout, out MetaInfo metaInfo)
        {
            ...
            try
            {
                ...
                // ReadTimeout으로 발생한 IOException도 타임아웃으로 간주
        ...
        public IPCamError GetImage_UDP(int timeout, out MetaInfo metaInfo)
        {
            ...
            try
            {
                ...
                // header error or broken buffer in the previous stream might cause the header packet to be lost or corrupted.
                // In that case, we need to clear the socket buffer and search for the header packet again.
                while (m_sock_SRM_UDP.Available > 0) {
                    m_sock_SRM_UDP.Receive(ref m_ep);
                }
        ...
        public IPCamError GetSerialNumber(out string serial)
        {
            ...
            try
            {
                ...
                else if (modelstr.StartsWith("I2CO"))
                    m_model = Model.iN2_23OC_C;
        ...
        {
            return m_model == Model.iN2_23SC_C || m_model == Model.iN2_23OC_C;
        }

        public bool IsInova2_Compact_ONSemi()
        {
            return m_model == Model.iN2_23OC_C;
        }
