...
set "Edge__DataDirectory=%LOCALAPPDATA%\ParkingSystem\FoundationTest"

echo [1/7] Parking.Api
set "ASPNETCORE_URLS=http://localhost:5000"
start "Parking.Api" cmd /k dotnet run --no-launch-profile --project src\Central\Parking.Api\Parking.Api.csproj
pause

echo [2/7] Parking.EdgeGateway
