...
namespace APSMain
{
    public partial class CarInNumForm : Form, ISubFormResult<string>, IActiveForm
    {
        ...
        private void CarInNumForm_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void CarInNum_Load(object sender, EventArgs e)
        {
        ...
        public void ParkCalFormDisplay()
        {
            ...
            if (ParkCache.GetCarMatchCount() == 1) {
                ...
                if (ParkCache.GetCarMatchCount() > 1) {
                    ...
                    UiHost.ShowActiveForm<string>(this, new CarSelectForm(_periodtype), (result, carNum) =>
                    {
                        Result = result;
                        ResultData = carNum;
        ...
        private void CarInNumForm_Shown(object sender, EventArgs e)
        {
        ...
        private void CarInNumForm_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        private async Task SearchEdgeServiceAsync()
        {
            try
            {
                ...
                if (_mainForm is null) { MessageBox.Show("MainForm이 초기화되지 않았습니다."); return; }
